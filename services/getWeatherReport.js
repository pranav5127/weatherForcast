...
function getWeather() {
    return __awaiter(this, void 0, void 0, function () {
        var params, url, responses, response, latitude, longitude, elevation, utcOffsetSeconds, hourly, weatherData;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    console.log("\nCoordinates: ".concat(latitude, "\u00B0N ").concat(longitude, "\u00B0E"), "\nElevation: ".concat(elevation, "m asl"), "\nTimezone difference to GMT+0: ".concat(utcOffsetSeconds, "s"));
